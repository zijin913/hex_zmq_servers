...
# -*- coding:utf-8 -*-
"""
MuJoCo Dual-Arm Archer L6Y Launch Script

Launches a single MuJoCo simulation with two L6Y arms (left + right)
sharing one physics scene. Both arms are controlled via the same ZMQ port.

Usage:
    source hex_zmq_servers/.venv/bin/activate
    python hex_zmq_servers/examples/basic/mujoco_archer_l6y_dual/launch.py
"""
...
NODE_PARAMS_DICT = {
    "mujoco_archer_l6y_dual_srv": {
        "name": "mujoco_archer_l6y_dual_srv",
        "node_path": HEX_ZMQ_SERVERS_PATH_DICT["mujoco_archer_l6y_dual"],
        "cfg_path": HEX_ZMQ_CONFIGS_PATH_DICT["mujoco_archer_l6y_dual"],
        "cfg": {
            "net": {
                "ip": "127.0.0.1",
                "port": 12345,
